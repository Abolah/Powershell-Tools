#----------------------------------------------------------------
# InstallDriverHL5440.ps1
# v1.0 - 27/10/2015
# Cholon Maxime
#----------------------------------------------------------------
#
## Description :
# Ce script sert à remplacer les drivers d'impressions de postes de travail
#
#
#Usage:
...
#Variable du CSV
$ComputerName = ""
$CSV_Path="D:\Powershell\InstallationPilotes\ScriptInstallImprimHL5440D\List_Computers.csv"
...
#Variables du Driver
    $driverName = "Brother HL-5440D series"
    $driverModel = "Brother HL-5440D series"
    $oldDriverModel = "Brother Mono Universal Printer (PCL)"
    $driverPath = "\TestNewDriver5440\DrvHl5440D"
    $infPath = "\TestNewDriver5440\DrvHl5440D\BROHLB1A.INF"
...
{ 
    ...
    $printer = $printers | where {$_.name -eq "Brother Mono Universal Printer (PCL)" -or $_.name -eq "Brother HL-5440D series"}
